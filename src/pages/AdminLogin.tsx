        ...
        <div className="pt-5 grid grid-cols-3 gap-2 mb-5">
          {[
            ...
            <div key={s.label} className="p-3 rounded-2xl bg-card border border-border text-center">
              <Icon name={s.icon} size={16} className="text-[#c8920a] mx-auto mb-1" />
          ...
          {([
            ...
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-1.5 py-2.5 rounded-xl text-xs font-medium transition-all ${
                tab === id ? "bg-[linear-gradient(135deg,#7a5c00_0%,#c8920a_20%,#ffd700_45%,#f0c040_55%,#c8920a_80%,#7a5c00_100%)] text-black" : "bg-card border border-border text-muted-foreground hover:text-foreground"
              }`}
            >
